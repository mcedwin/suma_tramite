<div id="page-wrapper" class="page-filter">
	<div class="page-header col-md-12">
		<div class="row page-header-title">
			<div class="col-sm-6">
				<h3>Todos los expedientes internos</h3>
			</div>
			<div class="col-sm-6 text-right" role="group" aria-label="...">
					<a href="<?=base_url()?>expedientes/internos_form?m=expedientes#1" title="Crear expedientes" class="btn btn-danger btn-sm">
		...
		<div class="row page-header-content">
			...
			<div class="nosel">
				...
				<div class="col-sm-3 text-right" role="group" aria-label="...">
					...
					<a class="btn btn-success btn-sm procesar" href="<?=base_url() ?>expedientes/dlgprocesar_interno" title="Procesar expedientes">
