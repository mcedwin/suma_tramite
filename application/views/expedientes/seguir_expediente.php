    ...
    <div class="modal-content">
		<form class="form-horizontal" action="<?php echo base_url()?>expedientes/guardar_derivar" method="post">
			...
			<div class="modal-body">
				...
				?>	
					<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-sm-6"><strong>Tipo</strong></label>
								<span><?php echo $expediente->expe_tipo; //isset($suma_plazo->deta_plazo)?$suma_plazo->deta_plazo." días":'-' ?></span>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-6"><strong>Remitente</strong></label>
			...
			<div class="modal-footer">
				<a href="<?php echo base_url() ?>expedientes/imprimir/<?php echo $expediente->expe_id ?>" target="_blank" class="btn btn-primary" id="imprimir" title="Imprimir">Imprimir</a>
