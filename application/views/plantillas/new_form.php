			...
			<div class="modal-body">
				...
				?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9"><?=form_input(array("name"=>"nombre","value"=>"","class"=>"form-control"));?></div>
					</div>
					<div class="form-group">
						<?=form_label('<strong>Archivo: </strong>', 'archivo',array('class' => 'col-sm-3 control-label')); ?>
						<div class="col-sm-6 archivo-actual"><?=form_label("", '',array('class' => 'control-label')); ?></div>
						<div class="col-sm-6 archivo-nuevo"><?=form_label("", 'archivo',array('class' => 'control-label','id'=>"archivo-adjunto")); ?><a href="#" class="eliminar"><i class="fa fa-times"></a></i></div>
