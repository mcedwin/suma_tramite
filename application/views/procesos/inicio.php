	...
	<div class="page-header col-md-12">
		<div class="row page-header-title">
			...
			<div class="col-sm-6 text-right" role="group" aria-label="...">
					<a href="<?php echo base_url()?>procesos/form/" title="Crear proceso" class="crear btn btn-danger btn-sm">
		...
		<div class="row page-header-content">
			<div class="onsel form-inline col-xs-12 hidden">
				<a class="btn btn-default btn-sm borrar" href="<?=base_url()?>procesos/borrar">
