...
var url = baseurl+'remitentes/inicio';
var $table;
var seleccionados;
	// alert(baseurl);
				...
				onrow: function (row, data) {
					...
					$(row).find('td.edit').click(function () {
						$(this).load_dialog({
							...
							custom_url: baseurl+'remitentes/form/' + data.DT_RowId,
							script: baseurl+'assets/js/remitentes/form.js',
	...
	$('a.borrar').click(function () {
		$this = $(this);
		$.confirm("¿Desea borrar los remitentes?", function () {
			$.gs_loader.show();
